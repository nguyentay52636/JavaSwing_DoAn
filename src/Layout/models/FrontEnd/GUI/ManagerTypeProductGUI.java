...
import Layout.models.FrontEnd.ButtonHandler.ButtonHandlerTypeProduct;

public class ManagerTypeProductGUI extends JPanel {
    ManagerTypeProductBUS qllsp = new ManagerTypeProductBUS();

    public ManagerTypeProductGUI() {
        initComponents();
    }
...
//                button2.setFont(button2.getFont().deriveFont(button2.getFont().getSize() + 5f));
                ...
                panel2.add(button2);
                ImageIcon addIcon = new ImageIcon(getClass().getResource("/Layout/images/icons8_add_30px.png"));
...
//                button3.setFont(button3.getFont().deriveFont(button3.getFont().getSize() + 5f));
                panel2.add(button3);
                ImageIcon deleteIcon = new ImageIcon(getClass().getResource("/Layout/images/icons8_delete_forever_30px_1.png"));
                button3.setIcon(deleteIcon);
                //---- button4 ----
                button4.setText("Sửa");
//                button4.setFont(button4.getFont().deriveFont(button4.getFont().getSize() + 5f));
                panel2.add(button4);
                ImageIcon editIcon = new ImageIcon(getClass().getResource("/Layout/images/icons8_wrench_30px.png"));
...
//                table1.setPreferredSize(new Dimension(800, ));
        ...
        button2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                // ButtonHandlerTypeProduct addButton = new ButtonHandlerTypeProduct("Thêm", "",
                // ManagerCustomerGUI.this);
                ButtonHandlerTypeProduct addButton = new ButtonHandlerTypeProduct("Thêm", "",
                        ManagerTypeProductGUI.this);
        ...
        button4.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedRow != -1) {
                    ...
                    ButtonHandlerTypeProduct addButton = new ButtonHandlerTypeProduct("Sửa", maLoai,
                            ManagerTypeProductGUI.this);
                    addButton.setVisible(true);
                } else {
        ...
        // XSSFSheet sheet = workbook.createSheet("Loại sản phẩm");
        ...
        // }
        // }
        // // ghi vao file excel co ten la LoaiSanPham.xlsx
        // try (FileOutputStream fileOut = new FileOutputStream("LoaiSanPham.xlsx")) {
        ...
        textField1.getDocument().addDocumentListener(new DocumentListener() {
            ...
            private void performSearch() {
                ...
                ArrayList<TypeProductDTO> result = qllsp.search(value, type);
    ...
    // set data to table
    public void setDataToTable(ArrayList<TypeProductDTO> data) {
        ...
        for (int i = 0; i < data.size(); i++) {
            TypeProductDTO typeProduct = data.get(i);
...
class Main {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ManagerTypeProductGUI form = new ManagerTypeProductGUI();
